...
** Util functions
For knowing that we are  on Mac
#+begin_src emacs-lisp
...
#+begin_src emacs-lisp :tangle no
  ...
  (general-def
   ...
   [remap describe-symbol] 'ghelp-describe-elisp
   [remap describe-function] 'ghelp-describe-function
   [remap describe-variable] #'ghelp-describe-variable
   [remap describe-key] 'ghelp-describe-key)
#+end_src
...
*** Spelling
#+begin_src emacs-lisp
  (setq ispell-program-name (with-temp-buffer
                              (call-process "which" nil t nil "aspell")
...
#+begin_src emacs-lisp
  ...
  (setq eldoc-box-offset '(-16 -16 16))
