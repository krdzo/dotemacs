...
#+begin_src emacs-lisp
  ...
  (set-face-attribute 'region nil :background "#501818")
...
#+begin_src emacs-lisp
  ...
  (use-package eglot
    :config
    (add-to-list 'eglot-server-programs '((web-mode :language-id "html") . ("html-languageserver")))
...
Ovde kad hocu nesto da probam/debagujem.
...
#+begin_src emacs-lisp
  (defun kr-meow-append ()
    "Correct append to go to insert mode after point."
  ...
  (defun meow-setup ()
    ...
    (meow-normal-define-key
     ...
     '("o" . meow-open-below)
     '("O" . meow-open-above)
     '("x" . kr-meow-delete-or-kill-on-selection)
  ...
  (defun kr-meow-delete-or-kill-on-selection ()
    "If selection is active then call `meow-kill' insted `meow-delete'"
    (interactive)
    (if meow--selection
