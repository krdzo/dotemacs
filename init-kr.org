...
#+BEGIN_SRC emacs-lisp :tangle no
  ...
  (global-set-key (kbd "M-n M-u") 'use-package-report)
#+END_SRC
...
#+begin_src emacs-lisp
  (use-package ghelp
    :straight (:type git :host github :repo "casouri/ghelp"))
#+end_src
...
** Visual line mode
#+begin_src emacs-lisp
  (use-package simple  ;package in which visual line mode is defined
    :straight (:type built-in)
    :ghook ('prog-mode-hook #'visual-line-mode)
...
#+begin_src emacs-lisp
  ...
  (use-package yasnippet
    ...
    :ghook ('yas-minor-mode-hook #'delete-selection-mode)
    :config
    (yas-reload-all)
...
#+BEGIN_SRC emacs-lisp
  (use-package lsp-mode
    ...
    ('lsp-mode-hook '(lsp-enable-which-key-integration yas-minor-mode))
    :init
...
#+begin_src emacs-lisp
  ...
  (add-hook 'java-mode-hook #'kr-set-comile-command)
...
#+begin_src emacs-lisp
  (use-package devdocs
    :defer
    :ghook ('devdocs-mode-hook #'olivetti-mode)
    :init
