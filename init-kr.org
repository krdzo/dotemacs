...
#+begin_src emacs-lisp
  ...
  (use-package meow
    :config
    (defun kr-save-last-state ()
      (setq kr-meow-last-state meow--current-state))

    (advice-add 'meow-insert :before #'kr-save-last-state)
    (defun kr-meow-insert-exit ()
      ...
      (cond
       ...
       ((meow-insert-mode-p)
        (meow--switch-state kr-meow-last-state))))
