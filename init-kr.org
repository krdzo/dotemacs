...
#+begin_src emacs-lisp
  (use-package mini-frame
    ...
    (add-to-list 'mini-frame-ignore-commands 'xref-find-references)
...
#+begin_src emacs-lisp
  (use-package apheleia
    :hook (js-mode-hook go-ts-mode-hook)
    :config
    (unless (executable-find "goimports")
      (error "no goimports found"))
    ...
    ;; `gofmt' doesn't sort and format imports so I
